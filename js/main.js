...
function hideOtherMenus(menu){
    switch (menu) {
        case "Desktop":
            ...
            if (!shoppingCartContainer.classList.contains("hide")) {
                shoppingCartContainer.classList.toggle("hide")
            }
...
function loadProductList(){
    productList.push ({
        name: 'Bike',
        description: 'With its practical position this bike also fulfills a decorative function, as your hall or workspace.',
        price: 320,
